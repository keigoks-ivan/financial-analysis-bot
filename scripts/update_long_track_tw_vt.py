...
兩標的日報酬 50/50 加權合成（等效每日再平衡，如實揭露）。判準基準＝<b>純長軌組合</b>（非買進持有）。<b>主列已含 10pp 門檻＋5% 取整執行層</b>（與本頁追蹤操作同規則）；「每日照調」為理論對照。「實倉引擎對照」＝2330/0050 E3（0..1 分數倉），同權重 50/50、同窗、同成本，<b>非本頁 0/1 閘門機制</b>。
...
<div class="page-hdr">
  <div class="container">
    ...
    <div style="margin-top:.6rem;display:flex;gap:.4rem;flex-wrap:wrap">
      <a href="/long-track-tw-vt/" style="font-size:.82rem;font-weight:600;padding:.35rem .8rem;border-radius:6px;background:var(--text);color:#fff;text-decoration:none">0050+2330 波動率（本頁）</a>
      <a href="/long-track-tw-vt/adaptive.html" style="font-size:.82rem;font-weight:600;padding:.35rem .8rem;border:1px solid var(--border);border-radius:6px;color:var(--muted);text-decoration:none">自適應 σ 版</a>
      <a href="/long-track-qs-vt/" style="font-size:.82rem;font-weight:600;padding:.35rem .8rem;border:1px solid var(--border);border-radius:6px;color:var(--muted);text-decoration:none">QQQ+SMH 波動率</a>
...
淨值線＝<b>正式追蹤版（含 10pp 門檻＋5% 取整執行層，與追蹤操作同規則）</b>；B&amp;H 線不變；<b style="color:var(--amber-text)">琥珀虛線＝實倉引擎（2330/0050 E3，同權重 50/50、同窗、同成本對照）</b>。
本頁系統（0/1 長軌閘門 × 波動率套袖 × 執行層）與實倉引擎（E3 分數倉 0..1）是不同機制；對照僅供「同一筆錢若改放實倉引擎規則」參考，<b>非替代關係</b>。美股版深度分析（純長軌對照、σ 敏感度、分期、年報酬）見 <a href="/backtest/vol_targeting/">波動率目標回測</a>。</p>
<div class="grid2">
