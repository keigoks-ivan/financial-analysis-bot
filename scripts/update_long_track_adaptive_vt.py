...
圖像化（Chart.js）：兩市場各一個合成曝險量表＋每腿乘法鏈 bar、近三年權重時間軸＋
RV20 vs σ_t（σ_t 本頁是動態線，非水平虛線）、回測縮圖（對數淨值＋回撤，BT_* 靜態快照）。
...
BT_US = {
    ...
    "verdict_pass": False,
    "rows": [
        ("自適應中位數 3y（本頁追蹤）", 11.51, -21.3, 0.5399, 7.95, 1.447),
        ("固定 σ 正式版（對照）", 11.90, -21.8, 0.5470, 8.21, 1.450),
...
BT_TW = {
    ...
    "verdict_pass": True,
    "rows": [
        ("自適應中位數 3y（本頁追蹤）", 18.53, -19.6, 0.9475, 8.60, 2.155),
        ("固定 σ 正式版（對照）", 18.54, -21.5, 0.8630, 9.05, 2.049),
...
BT_NAV_US = {
    ...
    "combo": [1.0,1.0019,1.0043,1.0066,1.009,1.0116,1.0141,1.0173,1.0202,1.0233,1.0266,1.0299,1.0234,1.0148,1.0277,1.0286,0.995,0.9992,1.0031,1.0076,1.016,1.0486,1.0689,1.0609,1.0743,1.0675,1.0723,1.1127,1.1319,1.1555,1.1498,1.1604,1.1872,1.1847,1.159,1.1589,1.1365,1.1384,1.1395,1.1408,1.1515,1.128,1.1296,1.1209,1.1219,1.1226,1.1227,1.1227,1.1228,1.1231,1.1233,1.1234,1.1236,1.1237,1.1239,1.124,1.1241,1.1242,1.1242,1.1243,1.1243,1.1244,1.1584,1.1716,1.1354,1.1058,1.0975,1.0709,1.0924,1.1268,1.1262,1.1529,1.1694,1.188,1.1874,1.2407,1.2198,1.1765,1.1507,1.0843,1.0713,1.0755,1.0501,1.0286,1.0635,1.0972,1.1248,1.1187,1.0801,1.0948,1.1016,1.13,1.1244,1.0946,1.0894,1.0868,1.1063,1.1209,1.1444,1.1828,1.2232,1.1986,1.2485,1.2229,1.2976,1.3507,1.3748,1.427,1.3922,1.4629,1.475,1.4487,1.5085,1.5832,1.5811,1.666,1.6503,1.6158,1.7071,1.6846,1.6441,1.7462,1.7005,1.7116,1.7922,1.6913,1.7054,1.6056,1.5884,1.6128,1.625,1.5781,1.4775,1.4778,1.5151,1.4555,1.4761,1.4424,1.5181,1.5582,1.6092,1.5831,1.6162,1.6266,1.7,1.7596,1.8156,1.8402,1.9455,1.8841,1.9496,2.0005,2.0506,2.1886,2.1956,2.1921,2.387,2.3189,2.2234,2.1862,2.3106,2.2738,2.3317,2.4268,2.3955,2.221,2.207,2.2109,2.2152,2.2235,2.2968,2.4304,2.196,2.222,2.2926,2.2219,2.252,2.3582,2.4479,2.5931,2.61,2.5564,2.4038,2.4301,2.5072,2.628,2.7933,2.9865,2.8948,2.8467,3.198,3.3453,3.424,3.4947,3.5052,3.5497,3.542,3.749,3.8101,3.9467,3.7289,4.0009,4.267,4.3112,3.9214,3.8824,3.7797,3.6854,3.6883,3.6926,3.6989,3.7075,3.717,3.7282,3.7409,3.7541,3.7675,3.7394,3.9323,3.8198,4.1372,4.3647,4.5699,4.4742,4.1997,4.0693,4.6042,4.9543,5.1553,5.6496,5.8496,5.5844,6.0667,6.5216,6.3078,6.2474,6.3696,6.3031,6.4769,6.508,6.5784,6.3392,6.0689,6.0902,6.2221,6.6864,6.8876,6.9395,7.5551,8.1074,7.8965,7.9154,8.4273,8.3411,7.8336,9.1381,10.3572,10.5729,10.3954],
...
BT_NAV_TW = {
    ...
    "combo": [1.0,1.0136,1.0741,1.0823,1.1055,1.163,1.1596,1.1907,1.1381,1.2166,1.2776,1.2679,1.2674,1.3169,1.285,1.3141,1.308,1.2877,1.2586,1.2109,1.2119,1.2067,1.1947,1.2116,1.1811,1.2033,1.2554,1.173,1.1919,1.2545,1.3187,1.3425,1.38,1.4052,1.3729,1.3622,1.3916,1.4198,1.4253,1.4543,1.5052,1.5899,1.6292,1.653,1.63,1.7752,1.6824,1.698,1.8425,1.7776,1.7662,1.6703,1.6439,1.654,1.7731,1.8326,1.8502,1.6631,1.6581,1.6594,1.6608,1.6643,1.6606,1.7446,1.6048,1.6273,1.7028,1.6886,1.7635,1.9052,1.9414,2.0904,2.0089,1.9948,1.7558,1.7947,1.7683,1.8809,2.3398,2.3173,2.3342,2.327,2.5738,2.8026,3.1088,3.1809,3.1519,3.248,3.1373,3.1572,3.0892,3.2188,3.0994,3.1104,3.1512,3.295,3.3514,3.2356,3.1423,3.0677,3.0702,3.0728,3.0754,3.0782,3.0807,3.0832,3.0859,3.0886,3.0902,3.0924,3.0952,3.0973,3.1,3.0588,3.0483,2.9687,2.8731,2.8727,3.1224,3.2229,3.3421,3.5835,3.8952,3.8598,3.9316,4.4438,4.3648,4.3214,4.4233,4.6306,4.4931,4.7811,5.0013,4.7165,4.1999,4.2033,4.1867,4.3616,4.7186,4.7622,5.3056,6.0022,5.7414,6.1174,6.9331,7.7215,7.0764,8.0546,8.7186,8.8663,8.5482],
...
def backtest_section(mkt: dict) -> str:
    ...
    if mkt["key"] == "tw":
        take = ('<b>台股版判定＝過關</b>：自適應中位數 3y／5y 兩窗同向，vs 固定 σ 正式版 '
                'Calmar 0.863 → <b>0.948</b>、Martin 2.05 → <b>2.16</b> 雙指標同步改善，'
                'MDD −21.5% → <b>−19.6%</b>，CAGR 幾乎不變（18.54% → 18.53%）。四分期 MDD 三期改善、'
                'AI 台積電牛僅微惡化（−1.3pp）。regime 中位數隨波動抬升，讓結構性高波的 2330 '
                '在多頭段少欠載，同時保留深回撤時的減碼。')
    else:
        take = ('<b>美股版判定＝雜訊級平手（FAIL）</b>：vs 固定 σ 正式版 Calmar 0.547 → 0.540、'
                'Martin 1.45 → 1.45，差距在四捨五入級，Calmar 略降即未通過「雙指標不劣」門檻——'
                '<b>FAIL 的意思是「無證據值得替換固定 σ」，不是「更差」</b>。五分期 MDD 四期改善、'
...
兩標的日報酬 50/50 加權合成（等效每日再平衡，如實揭露）。判準基準＝<b>固定 σ 正式版</b>（本頁與固定 σ 版的差異只在套袖，閘門完全相同）。
數字轉錄自 results/vol_targeting/adaptive_sigma.json。</p>
...
<div class="card">
<h3>分期（{mkt['short']} 自適應中位數 3y vs 固定 σ；ΔCAGR／ΔMDD，正＝自適應較優）</h3>
...
# ---------------------------------------------------------------------------
def _market_data(mkt: dict, sigs: dict, history: list) -> dict:
    legs = mkt["legs"]
    a, b = legs[0], legs[1]
...
<div class="card">
<h3>{mkt['short']} 近三年權重時間軸 — 兩腿最終權重 ＋ 合成曝險</h3>
...
<div class="card">
<h3>{mkt['short']} 回測縮圖 — 自適應中位數 3y vs 50/50 B&amp;H（對數淨值＋回撤）</h3>
<p style="font-size:.8rem;color:var(--muted);margin-bottom:.6rem">
回測快照（{mkt['bt_nav']['labels'][0]} → {mkt['bt_nav']['labels'][-1]}，由 run_adaptive_sigma 月度 NAV 靜態轉錄）。</p>
<div class="grid2">
...
new Chart(document.getElementById('chart-weights-{suf}'),{{
  ...
  data:{{labels:W_LAB_{suf},datasets:[
    {{label:'合成曝險',data:{H['comb']},borderColor:GREEN,backgroundColor:'rgba(22,163,74,0.07)',
     borderWidth:2.4,pointRadius:0,pointHoverRadius:3,tension:0.15,fill:'origin',segment:{{borderDash:segDash_{suf}}}}},
    {{label:'{legs[0]} 腿',data:{H['a']},borderColor:BLUE,borderWidth:1.5,pointRadius:0,pointHoverRadius:3,tension:0.15,segment:{{borderDash:segDash_{suf}}}}},
    {{label:'{legs[1]} 腿',data:{H['b']},borderColor:AMBER,borderWidth:1.5,pointRadius:0,pointHoverRadius:3,tension:0.15,segment:{{borderDash:segDash_{suf}}}}}
  ]}},
...
new Chart(document.getElementById('chart-bt-nav-{suf}'),{{
  ...
  data:{{labels:BT_LAB_{suf},datasets:[
    {{label:'自適應中位數 3y',data:BT_C_{suf},borderColor:GREEN,borderWidth:2,pointRadius:0,pointHoverRadius:3,tension:0.1}},
...
new Chart(document.getElementById('chart-bt-dd-{suf}'),{{
  type:'line',
  data:{{labels:BT_LAB_{suf},datasets:[
    {{label:'自適應中位數 3y',data:_dd(BT_C_{suf}),borderColor:GREEN,backgroundColor:'rgba(22,163,74,0.12)',borderWidth:1.4,fill:'origin',pointRadius:0,tension:0.1}},
...
def generate_html(sigs: dict, changes: list | None, last_change_date: str | None,
    ...
    md_map = {m["key"]: _market_data(m, sigs, hist_map.get(m["key"], [])) for m in MARKETS}
    ...
    change_html = (
        ...
        ('<div style="text-align:center;font-size:.78rem;color:var(--muted);margin:.3rem 0 1rem">'
         '無可行動變化（四腿閘門未翻轉、且無標的最終權重變動 ≥ 10pp）' +
...
<span style="color:var(--muted);font-size:.78rem">閘門為週頻（僅週五可能翻轉），套袖 RV20／σ_t 為日頻（每日可能微調），故本頁每交易日更新（台股收盤後、美股收盤後各一次，date-keyed 冪等）。「可行動變化」＝任一腿閘門翻轉或最終權重變動 ≥ 10pp，觸發 email 通知（訊息標市場前綴）。</span>
</div>
</div>
...
def detect_changes(prev: dict, sigs: dict) -> list:
    """可行動變化＝任一腿閘門翻轉，或任一腿最終權重變動 ≥ 10pp（vs 前一日 state）。
    訊息標市場前綴（美股／台股）。"""
...
def main():
    ...
    html = generate_html(sigs, changes, last_change_date, hist_map)
