...
PREREG = {
    ...
    "shadows": {
        ...
        "amendments": [
            ...
            {
                "date": "2026-09-15",
                "what": "股票腿（QQQ/SMH/0050/2330）的實單主系統加一道日線均線確認："
                        "五條件全對 cap_eff=1.5、否則退回 1.0（三個價格條件加 1% 遲滯）",
                "why": "持有人拍板：不在跌中借錢寫進規則，比事後手動減碼誠實；回測見 "
                       "rule_ledger.md「實單主系統規則鏈」修訂與 kill condition (d)(e)",
                "unchanged": "本記分板讀 state.json 的 source=='live' 實錄，2026-09-15 起這些實錄"
                             "反映的規則含均線層——SPRT 參數（k、n_eff floor、判定門檻）、四條影子帳戶"
                             "定義與判定語意全部不變；舊規則（無均線層）轉為唯讀影子 noma.html，"
                             "不進本記分板",
            },
        ],
        "disclosure": (
