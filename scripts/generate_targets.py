...
LENS_META = [  # order = display order
    ...
    ("enter",   "✅", "進場",   "站上 DD 統一裁決 = 進場（已深研且判進場）"),
...
<div class="wrap">
  <h1>🎯 標的產生器 — 跨層最強訊號</h1>
  <p class="sub">
    把三層漏斗（<b>形狀掃描</b> × <b>主表統一裁決</b> × <b>產業候選池</b>）疊在一起，只留<b>多個獨立訊號同時指向</b>的名字——單一訊號是雜訊，多層同意才是火力。
...
{rows}
  ...
  <p class="note">
    <b>怎麼用：</b>火力越高＝越多獨立方法同意，優先看。<b>✅ 有 DD</b> 的名字站上已深研，點「讀站上裁決」看統一裁決結論當你研究的起點；
