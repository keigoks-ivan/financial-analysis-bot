...
<td class="left"><b>宇宙全掃（S&amp;P 1500）＋結算所置於中心</b>——每個判斷自動對答案，季度校準改規則</td></tr>
</tbody></table>
</div>
...
<p>S&amp;P 1500 週掃：結構訊號批量 → 候選逐檔 EPS 修正確認。{radar_stat}</p>
...
<tbody>
<tr><td class="left">宇宙</td><td class="left">S&amp;P 1500 全掃（發現池外）</td><td class="left">240 檔 DD 策展池（深研）</td></tr>
