...
.tag-pool{background:#eaf5ef;color:var(--pos)}
.tag-blind{background:#f8f1e2;color:var(--warn)}
.tag-up{background:#eaf5ef;color:var(--pos)}
.tag-dn{background:#faecea;color:var(--neg)}
...
.warn{background:#f8f1e2;border-color:var(--warn);color:var(--warn)}
...
.st-live{background:#eaf5ef;color:var(--pos)}
