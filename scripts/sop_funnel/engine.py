...
PREREG = {
    ...
    "c_cooling_adjudication": (
        ...
        "或平均 α ≤0 → C 退回純記錄（恢復偏熱〔態2〕否決終局）；否則轉正。設計依據 = 2022-2026 "
        "replay（偏熱〔態2〕-only 否決 1,574 筆：冷卻再武裝均值 +24.6% vs 現行等回踩 +12.9%，"
    ...
    "quarterly_review_items": [
        ...
        "出場等回歸（態5）出場改 T+1 開盤（生死線不該多扛一個交易日；模擬端需先建 OHLC 資料層）",
