...
.footer{padding:20px 32px 28px;font-size:11px;color:#94a3b8;line-height:1.8;max-width:min(1240px,96vw);margin:6px auto 0;border-top:1px solid #dce8f5;text-align:center}
