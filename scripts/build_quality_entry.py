...
.caveat-panel{{background:#f8f1e2;border:1px solid #ecd9ab;border-radius:var(--r);padding:14px 18px;margin-bottom:20px;font-size:12px;color:var(--warn);line-height:1.65}}
