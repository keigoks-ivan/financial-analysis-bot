...
def render_tiles(j, scenario_meta):
    ...
    # 2026-09-07：快速版 tile 與完整版、dd-meta、revlog 共用 resolver。
    scenario_metrics = resolve_scenario_metrics(j, scenario_meta, source="dd_brief")
    ev5y = scenario_metrics.get("ev5y_pct")
    irr = scenario_metrics.get("irr_base_pct")
    ar = scenario_metrics.get("asym_ratio")
