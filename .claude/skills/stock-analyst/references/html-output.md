# stock-analyst v14.12 — html-output.md（條件載入 reference）
...
| **倉位角色** | §14a `dca_role` | 核心/衛星/追蹤/不持有（v14.12 四值，「條件式」語意由 §14a 執行語承載） |
