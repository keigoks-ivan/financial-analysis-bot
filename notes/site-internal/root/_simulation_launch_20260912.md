...
2026-09-12：依使用者要求，日／週／月 K 及 MA20／60／120 改用已生效拆併股與現金股息比例還原，基準為目前重播日。B／S 與畫線共用同一事件因子，舊版畫線可恢復；只調整圖表，實際成交與股息帳務不變。資料未提供的其他公司行動不補造。來源版本見 release.json，交易室共 62 項測試通過。
