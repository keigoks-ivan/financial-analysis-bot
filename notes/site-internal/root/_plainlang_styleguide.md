...
| 同店（same-store，DD 報告與判斷檔沿用公司財報用語） | — | **本業成長（不含併購）**——首現寫「本業成長（不含併購，公司財報稱 same-store）」，之後用「本業」；機器欄 `same_store` 不動 | 2026-09-11 持有人：FIX 報告「同店成長指引」讀者看不懂；該詞是滾動併購公司剔除新購事業的有機口徑，不是零售同店 |
