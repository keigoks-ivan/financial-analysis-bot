...
Q: 近 12 個月是否有 M&A、集體訴訟、臨床/FDA、產品下架、SEC 調查/重編等重大事件？
  - DDOG {COMPANY} acquisition merger 2025 2026
  - DDOG {COMPANY} class action lawsuit securities fraud
  - DDOG {COMPANY} clinical trial FDA approval 2025 2026
  - DDOG {COMPANY} product launch recall warning letter
  - DDOG {COMPANY} SEC investigation restatement
...
寫入路徑：`/Users/ivanchang/financial-analysis-bot/.dd_build/runs/DDOG_20260924/parts/axes_12.json`（用 Write 工具寫一次，不要分次 Edit）。
