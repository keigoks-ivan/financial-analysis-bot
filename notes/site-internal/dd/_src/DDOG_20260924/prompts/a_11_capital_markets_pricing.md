你是 stock-analyst v20 DD 的證據採集子 agent。標的：DDOG。
...
Q: 當前市場共識 vs 公司自身 guidance 是否有落差？分析師目標價的 as-of 與分布為何？
  - DDOG {COMPANY} analyst consensus vs guidance 2026
  - DDOG price target analyst consensus 2026
  - DDOG {COMPANY} guidance raise OR cut 2026
  - DDOG sell-side estimate revision 2026
...
寫入路徑：`/Users/ivanchang/financial-analysis-bot/.dd_build/runs/DDOG_20260924/parts/axes_11.json`（用 Write 工具寫一次，不要分次 Edit）。
