...
Q: 近 12 個月是否有 M&A、集體訴訟、臨床/FDA、產品下架、SEC 調查/重編等重大事件？
  - AMD {COMPANY} acquisition merger 2025 2026
  - AMD {COMPANY} class action lawsuit securities fraud
  - AMD {COMPANY} clinical trial FDA approval 2025 2026
  - AMD {COMPANY} product launch recall warning letter
  - AMD {COMPANY} SEC investigation restatement
...
寫入路徑：`/Users/ivanchang/financial-analysis-bot/.dd_build/runs/AMD_20260923/parts/axes_12.json`（用 Write 工具寫一次，不要分次 Edit）。
