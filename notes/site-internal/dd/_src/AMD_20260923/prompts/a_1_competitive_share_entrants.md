...
Q: 本標的與主要對手的份額消長方向為何？是否有新進入者或替代供應商在搶單？
  - AMD {COMPANY} market share gaining OR losing 2026
  - {COMPANY} new entrant OR displace threat {INDUSTRY} 2026
  - AMD competitor design win 2026
...
寫入路徑：`/Users/ivanchang/financial-analysis-bot/.dd_build/runs/AMD_20260923/parts/axes_1.json`（用 Write 工具寫一次，不要分次 Edit）。
