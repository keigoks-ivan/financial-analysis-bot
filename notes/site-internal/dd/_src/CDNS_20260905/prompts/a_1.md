...
寫入路徑：`/Users/ivanchang/financial-analysis-bot/.dd_build/runs/CDNS_20260905/parts/axes_1.json`（用 Write 工具寫一次，不要分次 Edit）。

## 交稿前跑（必過才回報）
```
python3 scripts/validate_evidence.py --part /Users/ivanchang/financial-analysis-bot/.dd_build/runs/CDNS_20260905/parts/axes_1.json
```
