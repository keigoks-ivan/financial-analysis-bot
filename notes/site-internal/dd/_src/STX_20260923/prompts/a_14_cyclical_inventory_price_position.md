...
[cyclical_inventory_price_position] 庫存與價格週期位置
Q: 當前處於庫存去化/回補的哪個階段？現貨/合約價格趨勢方向為何？
...
寫入路徑：`/Users/ivanchang/financial-analysis-bot/.dd_build/runs/STX_20260923/parts/axes_14.json`（用 Write 工具寫一次，不要分次 Edit）。
