...
Q: 生產地或關鍵供應鏈環節是否集中在地緣風險區域？是否有單點失效風險？
  - STX {COMPANY} manufacturing location geopolitical risk 2026
  - {COMPANY} supply chain single point of failure {INDUSTRY}
  - STX {COMPANY} Taiwan OR China OR geopolitical exposure 2026
...
寫入路徑：`/Users/ivanchang/financial-analysis-bot/.dd_build/runs/STX_20260923/parts/axes_7.json`（用 Write 工具寫一次，不要分次 Edit）。
