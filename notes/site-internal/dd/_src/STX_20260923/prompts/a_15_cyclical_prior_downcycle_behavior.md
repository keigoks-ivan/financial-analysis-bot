...
[cyclical_prior_downcycle_behavior] 上一輪下行的實際價格行為
Q: 上一次產業下行時，價格/毛利率實際跌到什麼程度、持續多久？
...
寫入路徑：`/Users/ivanchang/financial-analysis-bot/.dd_build/runs/STX_20260923/parts/axes_15.json`（用 Write 工具寫一次，不要分次 Edit）。
