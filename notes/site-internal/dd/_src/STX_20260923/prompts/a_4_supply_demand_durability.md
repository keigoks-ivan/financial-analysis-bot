...
Q: 當前供需失衡（緊缺或過剩）是結構性還是週期性？能撐多久？
  ...
  - STX {COMPANY} product demand durability structural 2026
...
寫入路徑：`/Users/ivanchang/financial-analysis-bot/.dd_build/runs/STX_20260923/parts/axes_4.json`（用 Write 工具寫一次，不要分次 Edit）。
