...
- `/Users/ivanchang/financial-analysis-bot/.dd_build/runs/TXN_20260907/judgment.json`（schema：`scripts/dd_schema/judgment.schema.json`；欄位語意見 bundle 內 schema 速查）
- `/Users/ivanchang/financial-analysis-bot/.dd_build/runs/TXN_20260907/scenario.json`（`dd_scenario.py` 輸入格式）
