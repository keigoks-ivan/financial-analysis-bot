...
[customer_second_source] 客戶 second-source 與 in-house
Q: 最大客戶是否正在導入第二供應商，或將此環節自製（in-house）？
  - LULU {COMPANY} largest customer second-source OR in-house 2026
...
寫入路徑：`/Users/ivanchang/financial-analysis-bot/.dd_build/runs/LULU_20260924/parts/axes_2.json`（用 Write 工具寫一次，不要分次 Edit）。
