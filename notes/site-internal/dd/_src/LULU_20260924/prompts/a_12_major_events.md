...
Q: 近 12 個月是否有 M&A、集體訴訟、臨床/FDA、產品下架、SEC 調查/重編等重大事件？
  - LULU {COMPANY} acquisition merger 2025 2026
  - LULU {COMPANY} class action lawsuit securities fraud
  - LULU {COMPANY} clinical trial FDA approval 2025 2026
  - LULU {COMPANY} product launch recall warning letter
  - LULU {COMPANY} SEC investigation restatement
...
寫入路徑：`/Users/ivanchang/financial-analysis-bot/.dd_build/runs/LULU_20260924/parts/axes_12.json`（用 Write 工具寫一次，不要分次 Edit）。
