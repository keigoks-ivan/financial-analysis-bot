...
Q: 本標的是否面臨反壟斷調查、拆分風險或產業特定監管新規？
  - LULU {COMPANY} antitrust OR monopoly investigation 2026
  - {COMPANY} regulation OR regulatory scrutiny {INDUSTRY} 2026
  - LULU {COMPANY} DOJ OR FTC OR EU competition 2026
  (na_allowed=true)
...
寫入路徑：`/Users/ivanchang/financial-analysis-bot/.dd_build/runs/LULU_20260924/parts/axes_5.json`（用 Write 工具寫一次，不要分次 Edit）。
