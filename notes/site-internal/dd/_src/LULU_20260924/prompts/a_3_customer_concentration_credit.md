...
Q: 前幾大客戶占營收比重多高？該客戶自身信用/財務狀況是否惡化？
  - LULU {COMPANY} top customer revenue concentration 10-K 2026
...
寫入路徑：`/Users/ivanchang/financial-analysis-bot/.dd_build/runs/LULU_20260924/parts/axes_3.json`（用 Write 工具寫一次，不要分次 Edit）。
