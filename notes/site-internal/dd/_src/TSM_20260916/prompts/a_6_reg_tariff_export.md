...
Q: 本標的的產品、供應鏈或客戶是否暴露在關稅或出口管制變動下？
  - TSM {COMPANY} tariff section 232 2026
  - {COMPANY} export control OR entity list {INDUSTRY} 2026
  - TSM {COMPANY} China tariff OR trade restriction 2026
...
寫入路徑：`/Users/ivanchang/financial-analysis-bot/.dd_build/runs/TSM_20260916/parts/axes_6.json`（用 Write 工具寫一次，不要分次 Edit）。
