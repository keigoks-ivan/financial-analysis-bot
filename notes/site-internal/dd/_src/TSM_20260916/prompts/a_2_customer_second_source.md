...
Q: 最大客戶是否正在導入第二供應商，或將此環節自製（in-house）？
  - TSM {COMPANY} largest customer second-source OR in-house 2026
...
寫入路徑：`/Users/ivanchang/financial-analysis-bot/.dd_build/runs/TSM_20260916/parts/axes_2.json`（用 Write 工具寫一次，不要分次 Edit）。
