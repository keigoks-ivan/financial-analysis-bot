...
Q: 此營收段的需求動能、市佔與價格走向為何（依 §3 營收段逐一列，per_segment 展開）？
  - TSM {COMPANY} {SEGMENT} segment revenue growth 2026
...
寫入路徑：`/Users/ivanchang/financial-analysis-bot/.dd_build/runs/TSM_20260916/parts/axes_8.json`（用 Write 工具寫一次，不要分次 Edit）。
