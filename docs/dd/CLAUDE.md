...
12. **v10.1 章節顯示序重新編號**:v9.2~v10.0 的章節編號按分析順序排列,但 HTML 顯示順序不同,導致讀者看到 §1→§2→§3→§5→§7→§8→§6→... 的亂跳。v10.1 將編號改為按 HTML 顯示順序：§1 投資結論→§2 R:R→§3 三方辯論→§4 序章→§5 論點錨定→§6 財報→§7 門檻檢核→§8 長期成長→§9 護城河→§10 財務品質→§11 產業→§12 治理→§13 估值。v9.2~v10.0 → v10.1 映射：舊§4(估值)→新§13、舊§5(序章)→新§4、舊§6(門檻)→新§7、舊§7(論點)→新§5、舊§8(財報)→新§6、舊§9(成長)→新§8、舊§10(護城河)→新§9、舊§11(財務)→新§10、舊§12(產業)→新§11、舊§13(治理)→新§12。§1/§2/§3 不變。消費模式解析 v9.2~v10.0 HTML 用舊編號,v10.1+ 用新編號。
