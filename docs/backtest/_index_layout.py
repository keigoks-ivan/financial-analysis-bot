    ...
    dict(id="macro", region="research", emoji="🌏", name="總經・房價×GDP",
         ...
         rows=[
            ("研究・主線", [
                ...
                ("/backtest/housing_gdp/income_horizon.html", "所得成長與房價：看對時間尺度，關係其實很強", "研究", False, True),
                ...
                ("/backtest/housing_gdp/household_debt.html", "家庭負債：房貸佔 GDP、佔所得、每月還款佔收入，還有多少空間", "研究", False, True),
            ]),
            ("個案・亞洲", [
