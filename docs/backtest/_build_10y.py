...
SYS = [
    ...
    ("SPY/QQQ 三訊號趨勢集成(採用)", "/backtest/long_track_ensemble/", "e3",
...
SCATTER = [
    ...
    ("SPY/QQQ 回歸", 16.46, 3.29, "#ca8a04"),
    ("🐢 唐奇安突破", 38.12, 24.13, "#0f766e"),
    ("SMH/QQQ 進攻", 20.04, 25.60, "#b45309"),
    ("QQQ+SMH 六狀態", 28.49, 22.40, "#d32f2f"),
    ("QQQ 六狀態實盤", 26.55, 21.02, "#b45309"),
    ("QQQ 長軌純攻", 25.18, 18.81, "#16a34a"),
    ("SPY/QQQ 集成", 21.15, 16.29, "#d97706"),
    ("SPY/QQQ 長軌", 18.75, 15.47, "#2e7d32"),
    ("SPY/AGG 斜率", 18.96, 13.04, "#0891b2"),
    ("雙動能", 21.54, 9.85, "#f57c00"),
    ("SPY/QQQ 雙軌", 19.61, 9.26, "#7c3aed"),
    ("📈 跨資產趨勢", 40.07, 13.16, "#6366f1"),
